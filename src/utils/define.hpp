...
#define CLOUD_TOPIC "/os1_cloud_node/points"
#define GPS_TOPIC "/gps/emlid/fix"
#define PACKAGE_NAME "lidarslam"
#define LIDAR_ODOMETRY_TOPIC "/lidar/odometry"
#define GPS_ODOMETRY_TOPIC "/gps/odometry"
